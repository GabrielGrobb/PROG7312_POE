using PROG7312_POE.UserResults;
using System;
...
namespace PROG7312_POE.HelperClasses
{
    public class BookHelper
    {
        ...
        /// <returns></returns>
        public UserResults.UserResults FindBestAttempt(List<UserResults.UserResults> results)
        {
            if (results.Count == 0)
            {
                return null;
        ...
        /// </summary>
        public void CalculateResults(string bookGame, int seconds, List<UserResults.UserResults> results,
                                      ...
                                      Dictionary<string, KeyValuePair<string, string>> correctOrderStructure)
        {
            ...
            results.Add(new UserResults.UserResults(attempt, correctBooks, timeTaken, gameName)
            {
                Attempt = attempt,
            ...
            UserResultsManager.AddUserResults(new UserResults.UserResults(attempt, correctBooks, timeTaken, gameName));
        }
        //-------------------------------------------------------------------------------------------//
